...
public class LaPrimitiva {
    public static void main() {
        ...
        int[] boletoBancaV = new int[tamBoleto];
        ...
        int complementarioBanca = random.nextInt(49) + 1;
        int reintegroBanca = random.nextInt(10);
